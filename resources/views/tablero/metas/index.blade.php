    ...
    @endif
        <nav>
          <div class="nav nav-tabs" id="nav-tab" role="tablist">
            <a class="nav-item nav-link alert-light active" id="nav-cursos-tab" data-toggle="tab" href="#nav-cursos" role="tab" aria-controls="nav-cursos" aria-selected="true">CURSOS</a>
            <a class="nav-item nav-link alert-light" id="nav-horas-tab" data-toggle="tab" href="#nav-horas" role="tab" aria-controls="nav-horas" aria-selected="false">HORAS</a>
            <a class="nav-item nav-link alert-light" id="nav-beneficiarios-tab" data-toggle="tab" href="#nav-beneficiarios" role="tab" aria-controls="nav-beneficiarios" aria-selected="false">BENEFICIARIOS</a>
            <a class="nav-item nav-link alert-light" id="nav-inversion-tab" data-toggle="tab" href="#nav-inversion" role="tab" aria-controls="nav-inversion" aria-selected="false">INVERSI&Oacute;N</a>
                         ...
                         <div class="table-responsive" style="min-height:420px" id="tabla">
                            <table class="table ">
                                <thead style="background-color: #ccc9c9;">
                                    <tr>
                                        <th scope="col" rowspan="2" class="text-dark" style="background-color: #ccc9c9; vertical-align: middle">#</th>
                                        <th scope="col" rowspan="2" class="text-left text-dark" style="background-color: #ccc9c9;  vertical-align: middle">UNIDAD DE CAPACITACI&Oacute;N</th>
                                        ...
                                        <th scope="col" rowspan="2" class="text-dark" style=" vertical-align: middle">TOTAL<br />CURSOS </th>
                                         <th scope="col" rowspan="2" class="text-dark" style=" vertical-align: middle">GRAF</th>
                                    </tr>
                                    <tr >
                                ...
                                <tbody class="list">
                                    ...
                                    @foreach($data as $items)
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="#" onclick="generarGRAF({{$n++}},'cursos','{{$items['unidad']}}.- CURSOS APERTURADOS' )" class="fa fa-cube text-blue" data-toggle="modal" data-target="#textGRAF"></a></td>
                                        </tr>
                                    @endforeach
                                    <tr class="text-dark">
                                        <td></td>
                                        ...
                                        <td>
                                            <a href="#" onclick="generarGRAF(11, 'cursos', 'ICATECH.- CURSOS APERTURADOS')" class="fa fa-cube text-blue" data-toggle='modal' data-target='#textGRAF' ></a>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                            ...
                            <table class="table ">
                                <thead style="background-color: #ccc9c9;">
                                    <tr>
                                        ...
                                        <th scope="col" colspan="2" class="text-center">NOV</th>
                                        <th scope="col" colspan="2" class="text-center">DIC</th>
                                        <th scope="col" rowspan="2" class="text-dark" style=" vertical-align: middle">TOTAL<br />HORAS</th>
                                         <th scope="col" rowspan="2" class="text-dark" style=" vertical-align: middle">GRAF</th>
                                    </tr>
                                    <tr >
                                        @foreach($lst_field as $m )
                                ...
                                <tbody class="list">
                                    ...
                                    @foreach($data as $items)
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="#" onclick='generarGRAF({{$n++}}, "hr" ,"{{$items["unidad"]}}.- CURSOS APERTURADOS EN HORAS")' class="fa fa-cube text-blue" data-toggle="modal" data-target="#textGRAF"></a></td>
                                    ...
                                    <tr class="text-dark">
                                        ...
                                        <td>
                                            <a href="#" onclick='generarGRAF(11,"hr","ICATECH.- CURSOS APERTURADOS EN HORAS")' class="fa fa-cube text-blue" data-toggle='modal' data-target='#textGRAF' ></a>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                            ...
                            <table class="table ">
                                <thead style="background-color: #ccc9c9;">
                                    <tr>
                                        ...
                                        <th scope="col" colspan="2" class="text-center">NOV</th>
                                        <th scope="col" colspan="2" class="text-center">DIC</th>
                                        <th scope="col" rowspan="2" class="text-dark" style=" vertical-align: middle">TOTAL<br />BENEF </th>
                                         <th scope="col" rowspan="2" class="text-dark" style=" vertical-align: middle">GRAF</th>
                                    </tr>
                                    <tr >
                                        @foreach($lst_field as $m )
                                ...
                                <tbody class="list">
                                    ...
                                    @foreach($data as $items)
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="#" onclick='generarGRAF({{$n++}},"benef","{{$items["unidad"]}}.- BENEFICIARIOS DE CURSOS APERTURADOS")' class="fa fa-cube text-blue" data-toggle="modal" data-target="#textGRAF"></a></td>
                                    ...
                                    <tr class="text-dark">
                                        ...
                                        <td>
                                            <a href="#" onclick='generarGRAF(11,"benef","ICATECH.- BENEFICIARIOS DE CURSOS APERTURADOS")' class="fa fa-cube text-blue" data-toggle='modal' data-target='#textGRAF' ></a>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                                ...
                                <tbody class="list">
                                    ...
                                    @foreach($data as $items)
                                        ...
                                        <tr>
                                            ...
                                            @foreach($lst_field as $k => $m)
                                                <?php
                                                if ($s%2==0) $color = 'class="bg-light"';
                                                else $color = '';
                                                ?>
                                                <td  <?php echo $color; ?> >{{ number_format($items['inversion_'.$m], 0, '', ',') }} </td>
                                                <?php
                                                $total_inversion += $items['inversion_'.$m];
                                                $s++;
                                                ?>
                                            @endforeach
                                            <td class="bg-light">{{ number_format($total_inversion, 0, '', ',') }}</td>
                                            <td><a href="#" onclick='generaGRAF_LINE({{$n++}},"{{$items["unidad"]}}.- INVERSIÓN DE CURSOS PAGADOS")' class="fa fa-cube text-blue" data-toggle="modal" data-target="#textGRAF"></a></td>
                                    ...
                                    <tr class="text-dark">
                                        ...
                                        @foreach($lst_field as $k => $m)
                                            ...
                                            ?>
                                            <td <?php echo $color; ?>>{{ number_format($dataT['inversion_'.$m], 0, '', ',')}}</td>
                                             <?php
                                        ...
                                        <td>
                                           <a href="#" onclick='generaGRAF_LINE(11,"ICATECH.- INVERSIÓN DE CURSOS PAGADOS")' class="fa fa-cube text-blue" data-toggle='modal' data-target='#textGRAF' ></a>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
...
@section('scripts_content')
    ...
    <script>
        function generarGRAF(opt, tipo, title){
            ...
            if(tipo=="benef"){
                var dataP = [d['benef_ene'],d['benef_feb'],d['benef_mar'],d['benef_abr'],d['benef_may'],d['benef_jun'],d['benef_jul'],d['benef_ago'],d['benef_sep'],d['benef_oct'],d['benef_nov'],d['benef_dic']];
                var dataR = [d['benef_ene_r'],d['benef_feb_r'],d['benef_mar_r'],d['benef_abr_r'],d['benef_may_r'],d['benef_jun_r'],d['benef_jul_r'],d['benef_ago_r'],d['benef_sep_r'],d['benef_oct_r'],d['benef_nov_r'],d['benef_dic_r']];
            }else if(tipo=="hr"){
                var dataP = [d['hr_ene'],d['hr_feb'],d['hr_mar'],d['hr_abr'],d['hr_may'],d['hr_jun'],d['hr_jul'],d['hr_ago'],d['hr_sep'],d['hr_oct'],d['hr_nov'],d['hr_dic']];
                var dataR = [d['hr_ene_r'],d['hr_feb_r'],d['hr_mar_r'],d['hr_abr_r'],d['hr_may_r'],d['hr_jun_r'],d['hr_jul_r'],d['hr_ago_r'],d['hr_sep_r'],d['hr_oct_r'],d['hr_nov_r'],d['hr_dic_r']];
            }else{
                var dataP = [d['ene'],d['feb'],d['mar'],d['abr'],d['may'],d['jun'],d['jul'],d['ago'],d['sep'],d['oct'],d['nov'],d['dic']];
                var dataR = [d['ene_r'],d['feb_r'],d['mar_r'],d['abr_r'],d['may_r'],d['jun_r'],d['jul_r'],d['ago_r'],d['sep_r'],d['oct_r'],d['nov_r'],d['dic_r']];
            }
    ...
    function generaGRAF_LINE(opt,title){
        ...
        var dataR = [d['inversion_ene'],d['inversion_feb'],d['inversion_mar'],d['inversion_abr'],d['inversion_may'],d['inversion_jun'],d['inversion_jul'],d['inversion_ago'],d['inversion_sep'],d['inversion_oct'],d['inversion_nov'],d['inversion_dic']];
