...
<body>
    ...
    <div class="contenedor">
        ...
        <br>
        <div align="justify" style="font-size:11px;">De {{ $reg_cursos[0]->tota }} cursos finalizados en el ciclo escolar {{ $reg_cursos[0]->ciclo }} en la Unidad de Capacitación {{ $reg_unidad->unidad }}, se reportan {{ $total }} para este mes</div>
        <br>
