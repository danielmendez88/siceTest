        ...
        if (isset($_POST['generarMemoAFirma'])) 
        {
            ...
            if (!empty($_POST['chkcursos_list'])) {
                ...
                try {
                    ...
                    ->groupby('unidad','curso','mod','inicio','termino','nombre','clave','ciclo','memos->TURNADO_EN_FIRMA->FECHA', DB::raw("observaciones_formato_t->'OBSERVACION_PARA_FIRMA'->>'OBSERVACION_FIRMA'"), 'arc')->get();
